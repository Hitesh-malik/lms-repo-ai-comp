  ...
  return (
    <div className="overflow-x-auto">
        ...
        <tbody className="whitespace-nowrap divide-y divide-gray-200">
          <tr>
            <td className="pl-4 w-8">
              <input id="checkbox9" type="checkbox" className="hidden peer" />
            ...
            <td className="px-4 py-3 text-sm text-slate-900 font-medium">
              <div className="flex items-center cursor-pointer w-max">
                <img src='https://readymadeui.com/team-1.webp' alt="team-1" className="w-9 h-9 rounded-full shrink-0" />
                <div className="ml-2">
                  <p>Tim Jones</p>
                </div>
              </div>
          ...
          <tr>
            ...
            <td className="px-4 py-3 text-sm text-slate-900 font-medium">
              <div className="flex items-center cursor-pointer w-max">
                <img src='https://readymadeui.com/team-2.webp' alt="team-2" className="w-9 h-9 rounded-full shrink-0" />
                <div className="ml-2">
                  <p>Olivia Smith</p>
                </div>
              </div>
            ...
            <td className="px-4 py-3 text-sm text-slate-600 font-medium">
              <a href="mailto:olivia.smith@email.com" className="underline">
          ...
          <tr>
            ...
            <td className="px-4 py-3 text-sm text-slate-900 font-medium">
              <div className="flex items-center cursor-pointer w-max">
                <img src='https://readymadeui.com/team-3.webp' alt="team-3" className="w-9 h-9 rounded-full shrink-0" />
                <div className="ml-2">
                  <p>Ava Thompson</p>
                </div>
              </div>
            ...
            <td className="px-4 py-3 text-sm text-slate-600 font-medium">
              <a href="mailto:ava.thompson@email.com" className="underline">
          ...
          <tr>
            ...
            <td className="px-4 py-3 text-sm text-slate-900 font-medium">
              <div className="flex items-center cursor-pointer w-max">
                <img src='https://readymadeui.com/team-4.webp' alt="team-4" className="w-9 h-9 rounded-full shrink-0" />
                <div className="ml-2">
                  <p>Noah Davis</p>
                </div>
              </div>
            ...
            <td className="px-4 py-3 text-sm text-slate-600 font-medium">
              <a href="mailto:noah.davis@email.com" className="underline">
          ...
          <tr>
            ...
            <td className="px-4 py-3 text-sm text-slate-900 font-medium">
              <div className="flex items-center cursor-pointer w-max">
                <img src='https://readymadeui.com/team-5.webp' alt="team-5" className="w-9 h-9 rounded-full shrink-0" />
                <div className="ml-2">
                  <p>Sophia Martinez</p>
                </div>
              </div>
            ...
            <td className="px-4 py-3 text-sm text-slate-600 font-medium">
              <a href="mailto:sophia.martinez@email.com" className="underline">
          ...
          <tr>
            ...
            <td className="px-4 py-3 text-sm text-slate-900 font-medium">
              <div className="flex items-center cursor-pointer w-max">
                <img src='https://readymadeui.com/team-6.webp' alt="team-6" className="w-9 h-9 rounded-full shrink-0" />
                <div className="ml-2">
                  <p>Liam Johnson</p>
                </div>
              </div>
            ...
            <td className="px-4 py-3 text-sm text-slate-600 font-medium">
              <a href="mailto:liam.johnson@email.com" className="underline">
          ...
          <tr>
            ...
            <td className="px-4 py-3 text-sm text-slate-900 font-medium">
              <div className="flex items-center cursor-pointer w-max">
                <img src='https://readymadeui.com/profile_2.webp' alt="profile_2" className="w-9 h-9 rounded-full shrink-0" />
                <div className="ml-2">
                  <p>Mason Wilson</p>
                </div>
              </div>
            ...
            <td className="px-4 py-3 text-sm text-slate-600 font-medium">
              <a href="mailto:mason.wilson@email.com" className="underline">
          ...
          <tr>
            ...
            <td className="px-4 py-3 text-sm text-slate-900 font-medium">
              <div className="flex items-center cursor-pointer w-max">
                <img src='https://readymadeui.com/profile_3.webp' alt="profile_3" className="w-9 h-9 rounded-full shrink-0" />
                <div className="ml-2">
                  <p>Isabella Brown</p>
                </div>
              </div>
            ...
            <td className="px-4 py-3 text-sm text-slate-600 font-medium">
              <a href="mailto:isabella.brown@email.com" className="underline">
      ...
      <div className="md:flex m-4">
        <p className="text-sm text-slate-600 flex-1">Showind 1 to 10 of 100 entries</p>
        ...
        <div className="flex items-center max-md:mt-4">
          ...
          <ul className="flex space-x-3 justify-center">
            ...
            <li
              className="flex items-center justify-center shrink-0 bg-blue-500  border hover:border-blue-500 border-blue-500 cursor-pointer text-sm font-medium text-white px-[13px] h-9 rounded-md">
              1
            </li>
            <li
              className="flex items-center justify-center shrink-0 border border-gray-300 hover:border-blue-500 cursor-pointer text-sm font-medium text-slate-900 px-[13px] h-9 rounded-md">
              2
            </li>
            <li
              className="flex items-center justify-center shrink-0 border border-gray-300 hover:border-blue-500 cursor-pointer text-sm font-medium text-slate-900 px-[13px] h-9 rounded-md">
